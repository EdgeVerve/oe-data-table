...
var OEUtils = window.OEUtils || {};
  ...
  OEUtils.metadataCache['literal-default'] = {
    'componentName': 'literal-default',
    'elements': {},
    'modelName': 'Literal',
    'modelAlias': 'literal',
    'metadata': {
...
class LiteralDefault extends OEFormValidationMixin(OEModelHandler(PolymerElement)){
    static get template(){
        return html`
...
window.customElements.metadefine("literal-default",OEFormMessagesMixin(LiteralDefault));

export default LiteralDefault;